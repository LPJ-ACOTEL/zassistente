		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Assitente de Vendas",
									"targetURL": "#comassistente-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comassistente-display": {
								"semanticObject": "comassistente",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.assistente",
									"url": sap.ui.require.toUrl("com/assistente")
								}
							}
						}
					}
